...
if (jQuery('#first-column-wrapper').length) {
  imagesLoaded('#first-column-wrapper', function() {
    var elem = document.querySelector('#portletPageFirstColumn #first-column-wrapper');
    var msnry = new Masonry(elem, {
       itemSelector: '#first-column-wrapper > div',
       gutter: 16,
       fitWidth: true,
       columnWidth: 210,
       horizontalOrder: true
    });
    $("#first-column-wrapper").addClass('init');
  });
}
...
jQuery(document).ready(function() {
  ...
  if(getBrowser()=='opera'){
    var $images = jQuery(".thumb-wrapper.past-event img")
    ...
    $images.one("load",function(){
      ...
      if (counter == imageCount) {
        ...
        grayscale(jQuery('.thumb-wrapper.past-event img'));
      }
    }).each(function () {
    if (this.complete) {
  ...
  if (getInternetExplorerVersion() >= 10){
    jQuery('.thumb-wrapper.past-event img').each(function(){
      var el = jQuery(this);
  ...
  function getBrowser(){
    ...
    var safari=navigator.userAgent.match(/webkit/i);
    var opera=navigator.userAgent.match(/opera/i);
    var msie=navigator.userAgent.match(/msie/i) && !navigator.userAgent.match(/opera/i);
    var mozilla= navigator.userAgent.match(/mozilla/i)
